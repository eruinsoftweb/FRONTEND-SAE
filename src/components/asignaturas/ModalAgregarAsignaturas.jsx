...
import { createAsignatura} from '../../features/asignaturaSlice';

const ModalAgregarAsignaturas = () => {
    ...
    const handleSave = () => {
        dispatch(createAsignatura(indice));
        setIsModalOpen(false)
        setIndice(initialValues)
    }
            ...
            <Modal isOpen={isModalOpen} onClose={handleModalClose} size="5xl" isCentered>
                ...
                />
                    <ModalContent _dark={{ bg: "primary.1000" }} borderRadius="2xl">
                        <ModalHeader textAlign="center">REGISTRAR ASIGNATURA</ModalHeader>
                        <ModalCloseButton />
                        <ModalBody>
