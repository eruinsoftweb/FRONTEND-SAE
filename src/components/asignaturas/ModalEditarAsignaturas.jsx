...
import { updateAsignatura } from '../../features/asignaturaSlice';

const ModalEditarAsignaturas = ({ row, modalidades }) => {
    ...
    const handleUpdate = () => {
        dispatch(updateAsignatura(indice));
        setIsModalOpen(false)
    }
                                ...
                                <Stack spacing={4} direction="row" justifyContent="space-between">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <option value="SECUNDARIA">NIVEL BACHILLERATO</option>
                                    ...
                                    <FormControl>
                                        ...
                                        <Select
                                            ...
                                            defaultValue={ indice ? indice.modalidad : '' }
...
export default ModalEditarAsignaturas