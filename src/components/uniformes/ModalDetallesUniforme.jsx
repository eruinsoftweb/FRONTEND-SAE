        ...
        <>
            ...
            >
                ...
                <DrawerContent _dark={{ bg: "primary.1000" }}>
                    <DrawerHeader fontWeight="bold" bg="purple.600" color="gray.200" textAlign="center">INFORMACIÓN BÁSICA DEL ARTICULO SELECCIONADO</DrawerHeader>
                    <DrawerBody>
                        <Stack direction="column" mt={6}>
                            <Stack direction={{ base: "column", lg: "row" }} w="full" justifyContent="stretch" spacing={6}>
                                <Image objectFit='cover' src={uniforme.img} fallbackSrc={fallbackIMG} alt={uniforme?.nombre} maxH={'360px'} maxW={'300px'} minW="250px" alignSelf={'center'} />
                                <Stack direction="column" mt={6} spacing={2} w="full">
                                    ...
                                    <Stack spacing={4} direction={{ xs: "column", sm: "column", md: "row", lg: "row" }} justifyContent="space-between">
                                        ...
                                        <Badge
                                            ...
                                            rounded="full"
                                        >
                                            $ {uniforme?.precio !== null ? uniforme?.precio : 0}
                                        </Badge>
                                    </Stack>
                                    <Divider />
                                    <Stack spacing={4} direction={{ xs: "column", sm: "column", md: "row", lg: "row" }} justifyContent="space-between">
