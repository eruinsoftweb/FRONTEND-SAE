...
import { getAllPagos, updateEstadoPago, reset } from '../../../features/pagos/RESIDENCIA/pagoSlice';
...
const Pagos = () => {
    ...
    const { pagos, isLoading, isError, message, currentPage, totalRows } = useSelector((state) => state.pagos_residencia);
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: row => (
                <div>
                    <Link
                        to={`/residencia/estudiantes/pagos/${row?.estudiante?._id}`}
                    >
                        <Text 
                            fontSize='xs'
                            color='blue.500'
                ...
                >
                    ...
                    <MenuList>
                        ...
                        >
                            ...
                            <Link to={{
                                pathname: '/residencia/pagos/boleta/' + row._id
                            }}>
