...
const ModalRegistrarPago = () => {
    ...
    const MyComponent = ({ data }) => {
        ...
        const tableRows = data?.concepto?.map((concepto, index) => (
            ...
            <td style="border: 2px solid black; padding: 0.5rem; text-align: center; font-family: Arial, Helvetica, sans-serif;">$ ${data?.importe}.00</td>
          </tr>`
        )).join('');
            ...
            <table style="border-collapse: collapse; width: 100%; margin-top: 1rem;">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th style="border: 2px solid black; padding: 0.5rem; text-align: center; font-family: Arial, Helvetica, sans-serif;">$ 0.00</th>
                    </tr>
                    <tr>
                        ${conceptoEsMensualidad?.length > 0 ? `<th></th>` : ''}
                        <th></th>
                        ...
                        <th style="border: 2px solid black; padding: 0.5rem; text-align: center; font-family: Arial, Helvetica, sans-serif;">$ ${data?.importe}.00</th>
                    </tr>
                </tfoot>
            </table>
        ...
        dispatch(createPago(indice)).then((data) => {
            ...
            if (detallePago?.estudiante?.correo !== '') {
                const dataSendEmail = {
                    ...
                    subject: 'SGE FACTURA DE PAGO - #' + detallePago?.codigo,
                    html: htmlString,
                }
                    ...
                    <ModalContent _dark={{ bg: "primary.1000" }} borderRadius="none">
                        ...
                        <ModalBody>
                            ...
                            <Stack spacing={4} direction={{ base: "column", lg: "row" }} justifyContent="space-between" mt={4}>
                                <FormControl isRequired>
                                    <FormLabel fontWeight="semibold">IMPORTE EN PESOS ($.)</FormLabel>
                                    <Input
                                        type={'number'}
