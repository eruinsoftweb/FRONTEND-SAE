                    ...
                    <Stack direction='column' h={'auto'} w="full" justifyContent="space-evenly" fontFamily={'Arial, Helvetica, sans-serif'} alignItems={'center'} alignSelf={'center'} spacing={4} display={'flex'}>
                        ...
                        <Stack direction={'column'} spacing={3} w="full" h="full" display={'flex'} fontSize={{ base: '12px', lg: '16px' }}>
                            <Stack direction={'column'} spacing={0}>
                                <Heading size="md" fontFamily={'Arial, Helvetica, sans-serif'}>CALI WEB ACADEMY</Heading>
                                <Text fontWeight={'light'}>Av.2 Oeste # 1 - 58 Peñon - Cali, Valle Cauca</Text>
                            </Stack>
                            <Stack direction={'row'} justifyContent={'space-between'} mt={2}>
                                <Stack direction="column" spacing={1}>
                                    <HStack spacing={1}>
                                        <Text fontWeight="bold">TELEFONO:</Text>
                                        <Text>(057)-6023477491</Text>
                                    </HStack>
                                    <HStack spacing={1}>
                                        <Text fontWeight="bold">SITIO WEB:</Text>
                                        <Text>www.academycaliweb.edu.co</Text>
                                    </HStack>
                                </Stack>
                                <Stack direction="column">
                                    <HStack spacing={1}>
                                        <Text fontWeight="bold" fontFamily={'Arial, Helvetica, sans-serif'} >CORREO:</Text>
                                        <Text>academycaliweb@gmail.com</Text>
                                    </HStack>
                                    <HStack spacing={1}>
                                        <Text fontWeight="bold">FACEBOOK:</Text>
                                        <Text>academycaliweb</Text>
                                    </HStack>
                                </Stack>
                            </Stack>
                        </Stack>
                        ...
                        <Stack direction="column" spacing={2} w="full">
                                ...
                                <Stack direction="row" spacing={2} justifyContent="space-between">
                                    ...
                                    <Stack direction="column" fontSize={'md'}>
                                        ...
                                        <HStack spacing={2}>
                                            ...
                                            <Text fontFamily={'Arial, Helvetica, sans-serif'}>PESOS</Text>
                                        </HStack>
                                    </Stack>
                                </Stack>
                            </Stack>
                            <Stack mt={4}>
                                <Table border={'2px'} mt={2}>
                                    <TableCaption border={'2px'} color={'black'} fontFamily={'Arial, Helvetica, sans-serif'}>El impuesto sobre las ventas no está incluido en el monto de la factura.</TableCaption>
                                    <Thead py={2}>
                                        <Tr>
                                            ...
                                            <Th color={'black'} fontSize={'md'} fontWeight={'bold'} isNumeric fontFamily={'Arial, Helvetica, sans-serif'} >TOTAL A PAGAR</Th>
                                        </Tr>
                                    </Thead>
                                    <Tbody py={2}>
                                        <Tr textAlign={'right'} border={'2px'}>
                                            ...
                                            <Td color={'black'} isNumeric fontSize='sm' fontWeight={'normal'} fontFamily={'Arial, Helvetica, sans-serif'}>$ {pago?.importe}.00</Td>
                                        </Tr>
                                    </Tbody>
                                    <Tfoot mt={4}>
                                        <Tr mt={4} border={'2px'}>
                                            ...
                                            <Th color={'black'} isNumeric fontSize='sm' fontWeight={'normal'} fontFamily={'Arial, Helvetica, sans-serif'}>$ 0.00</Th>
                                        </Tr>
                                        <Tr mt={4}>
                                            {
                                                conceptoEsMensualidad?.length > 0 ? (
                                            ...
                                            <Th></Th>
                                            <Th color={'black'} fontSize='md' fontWeight={'bold'} fontFamily={'Arial, Helvetica, sans-serif'}> TOTAL:</Th>
                                            <Th color={'black'} isNumeric fontSize='sm' fontWeight={'normal'} fontFamily={'Arial, Helvetica, sans-serif'}>$ {pago?.importe}.00</Th>
                                        </Tr>
                                    </Tfoot>
                                </Table>
                            </Stack>
