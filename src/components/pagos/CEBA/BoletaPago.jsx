                                ...
                                <Table border={'2px'} mt={2}>
                                    ...
                                    <Tfoot mt={4}>
                                        <Tr mt={4} border={'2px'}>
                                            <Th></Th>
                                            <Th></Th>
                                            <Th color={'black'} fontSize='md' fontWeight={'bold'} fontFamily={'Arial, Helvetica, sans-serif'} >SUBTOTAL:</Th>
