...
const AgregarEstudiante = () => {
    ...
    let gradosFilter = grados.filter(grado => (grado.modalidad === "EBR" || grado.modalidad === "CEBA") && grado.estado !== false );
                    ...
                    <Stack spacing={4} direction="column" justifyContent="space-between" p={2}>
                        ...
                        <Stack spacing={2} direction={{ base: 'column', lg: "row" }} justifyContent="space-between">
                            <FormControl isRequired>
                                ...
                                >
                                    <option value="EBR">ADNIN</option>
                                    <option value="CEBA">DOCENTE</option>
                                </Select>
                            </FormControl>
                            <FormControl isRequired>
