...
import { BoletaPagoCEBAPage, PagosCEBAPage, PagosCEBAPageDetalles } from '../pages/pagos/CEBA';
    ...
    return (
        <Routes>
            <Route element={<PrivateRoutes />} >
                ...
                <Route path='/ebr/pagos/boleta/:id' element={<BoletaPagoPage />} />
                ...
                <Route path='/ceba/pagos/boleta/:id' element={<BoletaPagoCEBAPage />} />
                ...
                <Route path='/residencia/pagos/boleta/:id' element={<BoletaPagoRESIDENCIAPage />} />
